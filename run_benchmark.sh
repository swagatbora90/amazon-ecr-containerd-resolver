...
# Constants
IMG_NAME="3gb-single-layer"
IMG="ecr.aws/arn:aws:ecr:us-west-2:167340705217:repository/${IMG_NAME}:latest"

ECR_IMG="167340705217.dkr.ecr.us-west-2.amazonaws.com/3gb-single-layer"
...
for i in 100; do
  for j in $(seq 1 1); do
    ...
    sudo ./test.sh ${CGROUP} ${OUTPUT_FILE} sudo ECR_PULL_PARALLEL="${ECR_PULL_PARALLEL}" ./bin/ecr-pull ${IMG}
